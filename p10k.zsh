# Generated by Powerlevel10k configuration wizard on 2019-10-09 at 22:14 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS}_FOREGROUND=77
  ...
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=173
  ...
  local vcs=''
  # If on a branch...
  vcs+='${${VCS_STATUS_LOCAL_BRANCH:+%231F'${(g::)POWERLEVEL9K_VCS_BRANCH_ICON}
  ...
  vcs+=':-%252F@%228F${VCS_STATUS_COMMIT[1,8]}}'
  # ':master' if the tracking branch name differs from local branch.
  vcs+='${${VCS_STATUS_REMOTE_BRANCH:#$VCS_STATUS_LOCAL_BRANCH}:+%253F:%171F${VCS_STATUS_REMOTE_BRANCH//\%/%%}}'
  # '#tag' if on a tag.
  vcs+='${VCS_STATUS_TAG:+%8F#%240F${VCS_STATUS_TAG//\%/%%}}'
  # ⇣42 if behind the remote.
  vcs+='${${VCS_STATUS_COMMITS_BEHIND:#0}:+ %159F⇣${VCS_STATUS_COMMITS_BEHIND}}'
  # ⇡42 if ahead of the remote; no leading space if also behind the remote: ⇣42⇡42.
  # If you want '⇣42 ⇡42' instead, replace '${${(M)VCS_STATUS_COMMITS_BEHIND:#0}:+ }' with ' '.
  vcs+='${${VCS_STATUS_COMMITS_AHEAD:#0}:+${${(M)VCS_STATUS_COMMITS_BEHIND:#0}:+ }%120F⇡${VCS_STATUS_COMMITS_AHEAD}}'
  # *42 if have stashes.
  vcs+='${${VCS_STATUS_STASHES:#0}:+ %195F*${VCS_STATUS_STASHES}}'
  ...
  vcs+='${${VCS_STATUS_NUM_STAGED:#0}:+ %51F+${VCS_STATUS_NUM_STAGED}}'
  # !42 if have unstaged changes.
  vcs+='${${VCS_STATUS_NUM_UNSTAGED:#0}:+ %191F!${VCS_STATUS_NUM_UNSTAGED}}'
  # ?42 if have untracked files. It's really a question mark, your font isn't broken.
  # See POWERLEVEL9K_VCS_UNTRACKED_ICON below if you want to use a different icon.
  # Remove the next line if you don't want to see untracked files at all.
  vcs+='${${VCS_STATUS_NUM_UNTRACKED:#0}:+ %153F'${(g::)POWERLEVEL9K_VCS_UNTRACKED_ICON}'${VCS_STATUS_NUM_UNTRACKED}}'
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND=248
  typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND=229
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=169
